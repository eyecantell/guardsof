...
- **Guardsof.com**: Secure internal platform for Guardians  
  ...
  - Manual upload form with TOS compliance checklist  

- **Nowfree.org**: Welcoming public-facing resource hub  
  - Clear Gospel walkthrough and next steps (prayer guides, curated hope videos)  
  - Geo-filtered list of vetted local churches and Bible studies (starting with Woodland Park partners)  
  - Optional anonymized follow-up surveys to measure impact and gather feedback  
  - Mobile-optimized, accessible, and intentionally non-pushy  

- **AI Tools**:  
  - Scan public posts ethically via platform APIs for need signals  
  - Generate context-aware opener suggestions  
...
- Grow through partnerships with like-minded churches (who benefit from new members referred via nowfree.org)  
- Future possibilities: targeted ads and broader online recruitment  
- Onboarding evolves from informal meetings to structured video training series  
- Ongoing support via small groups for sharing stories, encouragement, and preventing burnout  

## Success Metrics
- **Primary Win**: Individuals helped to join a local church community  
- **Quantitative**: Response rates, conversation depth, resource clicks on nowfree.org, church connections reported, optional survey responses  
- **Qualitative**: Sprout-rated conversations, guardian testimonials, stories of transformed lives  
- **Operational**: High guardian retention, zero TOS/privacy violations, continuous improvement in queue accuracy and opener effectiveness  

## Funding & Sustainability
- Start with minimal costs using free tiers and open-source tools  
